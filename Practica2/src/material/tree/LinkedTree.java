...
public class LinkedTree<E> implements Tree<E> {
    ...
    public Position<E> moveSubtree(Position<E> pOrig, Position<E> pDest) 
    	...
    	destino.getChildren().add(origen);
    	origen.setParent(destino);
    	if(origen.equals(destino)) throw new InvalidPositionException();
    	if (isRoot(pOrig)) throw new InvalidPositionException();
    	if(origen.equals(destino.parent)) throw new InvalidPositionException();
